    ...
    (async()=>{
      ...
      if(last?._portfolio){
        ...
        setLive({
          ...
          crypto: {...CURRENT.crypto, total:cryptoTotal, items:cryptoItems},
          stocks: {...CURRENT.stocks, total:stocksTotal, items:stocksItems},
          bank:   {...CURRENT.bank, totalEUR:bankEUR, breakdown: p.bank?.breakdown || CURRENT.bank.breakdown},
          errors: [],
